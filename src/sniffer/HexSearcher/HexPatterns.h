    ...
    namespace Legion
    {
        ...
        namespace Test
        {
            namespace x64
            {
                ...
                static const std::vector<unsigned char> GetCurrentWowLocale() { return { 0x8B, 0x05, 0x00, 0x00, 0x49, 0x01, 0xC3, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0x48, 0x63, 0xC1, 0x48, 0x8D, 0x0D, 0x56, 0x00 }; }
            ...
            namespace x86
            {
                static const std::vector<unsigned char> NetClient_ProcessMessage() { return { 0x55, 0x8B, 0xEC, 0x51, 0xFF, 0x05, 0xBC, 0x00, 0x00, 0x01, 0x8D, 0x45, 0xFC, 0x53, 0x56, 0x57 }; }
                ...
                static const std::vector<unsigned char> GetCurrentWowLocale() { return { 0xA1, 0x9C, 0x00, 0x00, 0x01, 0xC3, 0x55, 0x8B, 0xEC, 0x8B, 0x45, 0x08, 0x8B, 0x04, 0x85, 0x00 }; }
